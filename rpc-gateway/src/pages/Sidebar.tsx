  ...
  return (
    ...
    >
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div style={{ fontSize: 14, fontWeight: 700, color: '#f8fafc', letterSpacing: '-0.01em', lineHeight: 1.2 }}>
              RydOne Public<br />
              <span style={{ fontSize: 12, fontWeight: 500, color: '#475569' }}>Endpoints</span>
            </div>
          </div>
      ...
      <div style={{ padding: '10px 10px 6px', flexShrink: 0 }}>
        <div style={{
          ...
          {(['mainnet', 'testnet'] as const).map((m) => (
            ...
            >
              {m === 'mainnet'
                ? (mode === 'mainnet' ? '● Mainnet' : '○ Mainnet')
                : (mode === 'testnet' ? '◌ Testnet' : '◌ Testnet')}
            </button>
          ))}
        </div>
      </div>
        ...
        <div style={{
          ...
          <input
            ...
            style={{
              ...
              color: '#e2e8f0', fontSize: 12, width: '100%', fontFamily: 'inherit',
            }}
          />
        </div>
      </div>
      ...
      <div style={{
        ...
        fontSize: 10, color: '#1e293b', letterSpacing: '0.08em', flexShrink: 0,
      }}>
        PROVEWITHRYD.XYZ
      </div>
